...
/* ============================================================
   MARKETMIND HEADER — HIGH VISIBILITY
============================================================ */
.mm-header {
    height: 72px;
    width: 100%;
    ...
    background: #F7FAFC !important;
    border-bottom: 1.5px solid #AFC0D3 !important;
...
.mm-logo {
    ...
    border: 1px solid #B8E0DD !important;
...
.mm-tool + .mm-tool {
    border-left: 1px solid #C0CDDA !important;
...
.mm-dot {
    ...
    background: #07945F !important;
    box-shadow: 0 0 0 4px #C5EFDD !important;

    opacity: 1 !important;
}

/* Force the complete custom header to remain fully visible */
.mm-header,
.mm-header *,
.mm-brand,
.mm-brand *,
...
.mm-feature:nth-of-type(2) .mm-check {
    background: #DDEAFF;
    color: #146BE0;
}

.mm-feature:nth-of-type(3) .mm-check {
    background: #E9E0FF;
    color: #7136D9;
}
...
.mm-card {
    ...
    box-shadow: 0 14px 38px rgba(24,55,92,.08);
    margin-top: 0;
}
...
div[data-testid="stButton"] button[kind="primary"] {
    ...
    background: #08736E;
    color: #FFF;
    box-shadow: 0 6px 15px rgba(8,115,110,.16);
}
...
@media(max-width: 800px) {
    ...
    .mm-header-tools .mm-help-icon,
    .mm-header-tools .mm-headphones {
