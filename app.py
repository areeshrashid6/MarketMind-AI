...
.mm-brand-name{font-size:16px;font-weight:800;color:#0B1935;line-height:1.1}.mm-brand-sub{font-size:11px;color:#526887;margin-top:3px}
.mm-header-tools{display:flex;align-items:center;gap:21px}.mm-tool{font-size:11px;color:#0D1C38;display:flex;align-items:center;gap:7px}.mm-tool+.mm-tool{border-left:1px solid #D5DFEA;padding-left:21px}.mm-help-icon{width:16px;height:16px;border:1.5px solid #0D1C38;border-radius:50%;display:grid;place-items:center;font-size:10px;font-weight:800}.mm-headphones{font-size:15px;color:#0D1C38}.mm-secure{font-size:11px;color:#0D1C38;display:flex;align-items:center;gap:8px}.mm-dot{width:7px;height:7px;border-radius:50%;background:#11A96D;box-shadow:0 0 0 4px #D3F3E5}
